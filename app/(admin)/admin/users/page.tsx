          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg bg-slate-50 border border-slate-200 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-blue-600/50 focus:ring-1 focus:ring-blue-600/20 transition-all"
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-medium text-slate-500 flex items-center gap-1.5">
