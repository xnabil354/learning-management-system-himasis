...
export function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 animate-in slide-in-from-bottom flex justify-center pointer-events-none">
      <div className="pointer-events-auto flex items-center gap-4 bg-[#0A0A0B]/90 backdrop-blur-xl border border-white/[0.1] px-5 py-3 rounded-full shadow-2xl shadow-violet-500/20 max-w-md w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white text-black font-semibold text-xs hover:bg-zinc-200 transition-colors disabled:opacity-50"
          >
